    ...
    <html>
        ...
        <body class="body">
            ...
            <div class="conteudoSudo">
                <div class="msg">
                    <h1>Inserção de vocabulário - Família e amigos</h1>
                    <form name="frmImage" enctype="multipart/form-data" action="inserirFam2.php" method="POST" class="frmImageUpload" onsubmit="return validaVoc()">
                    ...
                    <a href="familia.php">VER  IMAGENS NO BANCO</a>
                </div>
            </div>
        </body>
    </html>