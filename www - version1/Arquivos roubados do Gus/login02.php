    ...
    <body>
        ...
        <div class="doc">
                ...
                require("crip2gr4.php");
                    $username=$_POST['username']; //vem do login 1 (name)
                    $senha=$_POST['pwd']; //vem do login 1 (name)                        
                    //login 
                    require("conectaBd.php");
                    $sql="SELECT nomeCompleto,senha from usuario where username=? "; //nao indica o texto $username; e sim apenas um parametro, representado por (?) 
                ...
                //teste senha antigo
                    ...
                    $_SESSION['username']=$username; //recupera o dcpf do operador
                    $_SESSION['operador']=$username; //informacao relevante
                    ...
                    //$_SESSION=array();                        
                    echo("<br><br> Seja bem vindo, jogador = ".$_SESSION['username']);
