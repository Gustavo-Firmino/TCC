	...
	<body>				
			...
			<div class= "doc">	
					<?php 
						...
						$cpf=$_POST['cpf'];
						if (strlen($cpf)<11) {
							echo"Um CPF necessita de 11 digitos. Retorne.<br>";
						}else {
							echo"CPF: $cpf <br>";
						}
						...
						echo"Operador CPF= ".$_SESSION['cpf'];
						$operador=$_SESSION['cpf'];//vairavel operador chama o cpf da sessaõ
						...
						$sql.="VALUES ";
						$sql.="('$cpf','$nomeCompleto','$sex','$data','$operador') ";
